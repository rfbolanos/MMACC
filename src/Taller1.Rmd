...
En ese sentido l modelo que tuvo menor error cuadratico medio es el modelo lasso con el $\lambda_{min}$, Sin embargo a se sugiere utilizar el $\lambda_{1se}$ por que penaliza mas variables que el $\lambda_{min}$.
...
Se realizan dos modelos uno con el lambda ajustado para fines de la predicción y otro modelo para realizar el grafico de las trazas.
